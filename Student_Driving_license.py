...
label_name = Label(root, text="Vishwajeeth")
label_dob = Label(root, text="5 May 2011")
label_pin = Label(root, text="451478")
label_address = Label(root, text="Solipur, Shadnagar , telangana-509216")
...
def mylicense():
    ...
    pin = 451478
    print(type(pin))
    address = "Solipur, Shadnagar , telangana-509216"
    print(type(address))
    ...
    label_vechicle_type["text"] = vechicle_type
    
button1 = Button(root, text="Show my drivivng license", command = mylicense)
button1.pack()
